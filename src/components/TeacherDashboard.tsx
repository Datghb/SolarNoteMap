...
export function TeacherDashboard({ lessons, customLessons, activities, onCreateLesson, onTogglePublish, onRefreshActivities, onClose }: {
  lessons: Lesson[];
  ...
  return <main className="teacher-dashboard">
    ...
    <section className="teacher-shell">
      ...
      <div className="teacher-main">
        ...
        {view === 'overview' && <>
          <header className="teacher-heading"><div><span>TỔNG QUAN LỚP HỌC</span><h2>Chào buổi học mới.</h2></div><button className="teacher-create inline" disabled={refreshing} onClick={() => void refreshActivity()}>{refreshing ? 'Đang tải…' : '↻ Làm mới hoạt động'}</button></header>
